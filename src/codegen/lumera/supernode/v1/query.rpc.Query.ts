...
export class QueryClientImpl implements Query {
  ...
  params = async (request: QueryParamsRequest = {}): Promise<QueryParamsResponse> => {
    ...
    const promise = this.rpc.request("lumera.supernode.v1.Query", "Params", data);
  ...
  getSuperNode = async (request: QueryGetSuperNodeRequest): Promise<QueryGetSuperNodeResponse> => {
    ...
    const promise = this.rpc.request("lumera.supernode.v1.Query", "GetSuperNode", data);
  ...
  getSuperNodeBySuperNodeAddress = async (request: QueryGetSuperNodeBySuperNodeAddressRequest): Promise<QueryGetSuperNodeBySuperNodeAddressResponse> => {
    ...
    const promise = this.rpc.request("lumera.supernode.v1.Query", "GetSuperNodeBySuperNodeAddress", data);
  ...
  listSuperNodes = async (request: QueryListSuperNodesRequest = {
    ...
    const promise = this.rpc.request("lumera.supernode.v1.Query", "ListSuperNodes", data);
